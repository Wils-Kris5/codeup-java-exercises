...
public class InheritanceandPolymorphism {
   //Inheritance
    ...
    //
    //Some things to keep in mind about overriding. You have to fulfill the protocol. The arguments must be the same, and return types must be compatible. Otherwise you are overloading, not overriding. And the method cannot be less accessible. You can't override a public method and make it private, that will generate a runtime error.
    //
    ...
    //
    //To review some array tecnhiques, we can use the enhanced for loop
    //
    //   for (Bird bird: birds) {
    //            bird.makeNoise();
    //        }
    //You can also have polymorphic arguments and return types. Let's see some examples of polymorphic arguments.
    //
    ...
    //    }
    //}
    //The BirdLover takes a duck to the vet at the Bird Shelter and the duck goes quack quack In BirdShelterTest:
    //
    ...
    //
    //We could even go polymorphic on return types.
    //
    //Garage.java:
    //
    ...
    //            }
    //        }
    //        Vehicle nopeNotHere = new Vehicle();
    //        nopeNotHere.setName(null);
    //        return nopeNotHere;
    //    }
    //GarageTest.java:
    //
    //        Vehicle customersCar =  garage.findVehicle("lambo", carsInTheGarage);
    //        System.out.println(customersCar.getName());
    //        Vehicle customer2car = garage.findVehicle("Mustang", carsInTheGarage);
    //        System.out.println(customer2car.getName());
    //        Vehicle customer3car = garage.findVehicle("Yellow tractor", carsInTheGarage);
    //        System.out.println(customer3car.getName());
    ...
    //
    //mini-exercise
    //Create a Vehicle constructor that takes a string argument. Watch the cascade of errors show up in IntelliJ. Make the error warnings go away by creating no-arg and string-arg constructors in all your classes.
    //
    ...
    //    }
    //Seems reasonable? It's actually an infinite loop. setName calls setName, which calls setName, which calls setName. You get a stackoverflow! Yes, a real one. BirdTest:
    //
    //        Duck rubberDucky = new Duck();
    //        rubberDucky.setName("Cody");
    //        System.out.println(rubberDucky.getName());
    //Exception in thread "main" java.lang.StackOverflowError
    //This is a runtime error, it compiles fine. Instead, I could do
    //
    //public void setName(String duckName){
    ...
    //
    //The final keyword
    //Ok, we have one final topic to cover and that is the final keyword. We have already seen the use of the final keyword to create constants in Java. In the lecture on syntax, types, and variables, we were introduced to this. Penguin:
    //
    ...
    //There are other uses for the final keyword, though. You can make a class final. This means the class can never be extended.
    //
